...
export default function profile() {
  return (
    <SafeAreaView>
      <ProfileHeader/>
      <View style={{marginHorizontal:"auto", width:"100%", backgroundColor:"#f8f8f8", padding:10, borderRadius:10, marginTop:10, height:"auto"}}>
        ...
        <View style={{marginTop:10, gap:10, padding:10}}>
          ...
          <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
           ...
           <View style={{ justifyContent:"space-between", gap:20, marginTop:10}}>
            <View style={{ flexDirection:"row", gap:10, marginTop:5, alignItems:"center", justifyContent:"space-between"}}>
